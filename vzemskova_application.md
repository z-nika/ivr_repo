...
<ol>
<li>Отслеживание срока хранения продуктов в холодильнике</li>
<li>Разделение холодильника на 3 зоны хранения: основная зона, дверца и морозилка; разные зоны хранения влияют на срок хранения продукта (пример: в морозилке мясо хранится дольше, чем в основной зоне; программа способна совершить перерасчёт срока годности)</li>
<li>Памятка о рекомендованных условиях хранения продукции определённого типа</li>
...
<li>Возможность вносить продукцию с помощью сканирования штрих-кода или Data Matrix</li>
<li>Хранение информации о каждой единице продукции (количество продукта в упаковке, единица измерения (мл, г), дата внесения в холодильник, срок годности продукта на упаковке, дата изготовления (если нет даты окончания срока годности на упаковке, но указан срок хранения, например, 12 месяцев), дата вскрытия упаковки, зона хранения)</li>
<li>Учёт времени, когда продукт был добавлен в холодильник при расчёте его оставшегося срока хранения</li>
<li>Возможность убрать из базы данных съеденный или выброшенный, использованный продукт</li>
<li>Отправка оповещений о скором окончании срока годности продукта, о продукте с истёкшим сроком годности</li>
<li>Определение типа продукции (молочная продукция, овощи, фрукты и прочие) с помощью ключевых слов или информации из штрих-кода/Data Matrix</li>
<li>Вычисление срока годности продукта после вскрытия на основе типа продукции</li>
<li>Возможность внесения продуктов в одну «упаковку»; объединение продуктов с одним сроком годности, при условии, что после вскрытия упаковки изменится срок хранения каждой единицы продукции</li>
<li>Возможность внесения дополнительной информации пользователем (заметка о продукте, когда прислать оповещение, вскрыта ли упаковка и прочее)</li>
<li>Визуализация виртуального хранилища продуктов</li>
<li>Возможность доступа к учётной записи на разных устройствах</li>
</ol>
