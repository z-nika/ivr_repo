...
<ol>
<li> Пользователь заходит в личный кабинет; на странице доступны настройки, ссылки на правила пользования веб-приложением, памятку</li>
...
<li> Если пользователь нажал на ссылку на правила пользования/памятку о хранении/памятку о веб-приложении в личном кабинете, то открывается новое окно с соответствующим текстом, запускается Сценарий 2 </li>
</ol>
...
<li> Если пользователь нажал "Добавить продукт" в одном из отделов холодильника (кроме главной страницы), то запускается Сценарий 3 </li>
</ol>
